...
const database = {
  information: {
    name: 'Carlos Fortes',
    aboutContent:
      "Always looking for a new opportunity to learn! As a programmer, I'm in a constant search for better practices and also experimenting new things. I love building web applications with Javascript, creating components, and putting them to work together!",
    age: 39,
    phone: '',
    nationality: 'Capeverdian',
    language: 'Portuguese, English',
    email: 'cdfortes@gmail.com',
    address: 'Praia, Santiago, Cabo Verde',
    freelanceStatus: 'Available',
    socialLinks: {
      facebook: '',
      twitter: 'https://twitter.com/cdfortes',
      pinterest: '',
      behance: '',
      linkedin: 'https://www.linkedin.com/in/carlos-duarte-fortes-a71362101/',
      dribbble: '',
      github: 'https://github.com/cdfortes',
      codepen: 'https://codepen.io/cdfortes'
    },
    brandImage:
      'https://avatars3.githubusercontent.com/u/8411016?s=460&u=6926246b4a4a25036e59748c5a31b2eca4e85972&v=4',
